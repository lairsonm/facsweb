<html>
    ...
    <body>
        <center>
            ...
            <a href="cadastrar_bebida.php"><img src="img/add.png">Cadastrar Bebida</a> <br>   
            <a href="cadastrar_tipo_bebida.php"><img src="img/add.png">Cadastrar Tipo de Bebida</a>
            <br><br>
            ...
            <tr>
                ...
                if (isset($_GET['delete_id'])) {
                    ...
                    // Executa o delete
                    $sql_delete="DELETE FROM tipo_bebida WHERE id='$delete_id'";
                    ...
                    echo "<script>
                        ...
                        location.href = 'listar_tipo_bebida.php';
                        </script>";
                    echo "<BR>";
                        } else {
                            echo "<script>
